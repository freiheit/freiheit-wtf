...
- Discord Feedbot
  Bot that sends posts from RSS/Atom feeds to Discord channels. Originally
  written specifically for Elite: Dangerous’ “galnet” feed, but supports all
  sorts of stuff now. The feedbot discord has a ton of followable rooms with
  feeds you can use.
